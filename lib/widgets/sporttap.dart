...
class SportTap extends StatelessWidget {
  const SportTap({Key? key, }) : super(key: key);
  @override
  Widget build(BuildContext context) {
    ...
    //           stream: FirebaseFirestore.instance.collection("Products1").snapshots(),
    ...
    //                           padding: EdgeInsets.only(right: 15),
    //                           child: FadeInImage.assetNetwork(
    //                             placeholder: 'images/anh3.jpg', image: snap[index]['imageUrl'],
    //                             fit: BoxFit.cover,
    //                             height: 100,
    //                             width: 100,
    //                           ),
